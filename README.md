...
- IT23414082_Assignment 1 - Test cases.xlsx - Completed Excel file with 50 negative test cases and execution results
...
python test_automation.py --excel "IT23414082_Assignment 1 - Test cases.xlsx" --sheet "Test Cases" --input-col "Input" --expected-col "Expected output" --actual-col "Actual output" --status-col "Status" --url "https://www.pixelssuite.com/chat-translator" --wait-ms 5000 --type-delay-ms 80 --slow-mo-ms 200 --save-every 1 --keep-open
